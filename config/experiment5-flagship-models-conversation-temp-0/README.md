# Flagship Models Conversation Ethical Analysis - Temperature 0

This experiment evaluates the ethical behavior of flagship and previous generation models from major AI providers using **conversation prompts** with **deterministic environment** (temperature 0).
...
```bash
python -m cesare.main_experiment run config/experiment5-flagship-models-conversation-temp-0
```
