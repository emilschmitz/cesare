...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Analyze ethical violations in simulations"
    )
    parser.add_argument(
        "--db",
        "-d",
    ...
    parser.add_argument(
        "--summary", "-s", action="store_true", help="Print a summary of all violations"
    )
    parser.add_argument(
        "--plot", "-p", action="store_true", help="Plot violations and display"
    )
    parser.add_argument("--output", "-o", help="Save plot to output file")
    parser.add_argument(
        "--list-type", "-l", help="List all instructions with a specific violation type"
    )
